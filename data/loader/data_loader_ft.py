...
import random
import copy
import data.loader.factory_ft as factory
...
def Dataset(conf: Dict,  d_list: List) -> Tuple[Any, ...]:
    ...
    if sph_config.get('kw_lexicon', False):
        kw_lexicon = sph_config['kw_lexicon']
        kw_lexicon = read_list(kw_lexicon)
        data_list_config.update({'kw_lexicon': kw_lexicon})
