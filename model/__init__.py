...
from model import TransformerKWSPhone_nocross_w_ctc_no_kw
...
m_dict = {
    ...
    'TransformerKWSPhone_nocross_w_ctc_no_kw': TransformerKWSPhone_nocross_w_ctc_no_kw.TransformerKWSPhone_nocross_w_ctc_no_kw,
