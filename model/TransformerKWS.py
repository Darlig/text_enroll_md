...
class TransformerKWS(nn.Module):
    def __init__(
        ...
        super(TransformerKWS, self).__init__()
    ...
    def evaluate(self, input_data):
        ...
        return kw_det_result, phn_label, asr_hyp.transpose(0,1), sph_len, kw_label, kw_len, cross_att_s2t, cross_att
