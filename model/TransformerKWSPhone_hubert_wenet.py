...
class TransformerKWSPhone_hubert_wenet(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        super(TransformerKWSPhone_hubert_wenet, self).__init__()
        self.sok = sok
        self.eok = eok
        # detach_config 
        # TODO: looks stupid ....   >_<
        ...
        # hubert frontend
        self.hubert = FrozenHubert('/work106/weiyang/project/maolidan_thesis/experiment/text_enroll_md_hubert_aishell2/pretrained_models/chinese-hubert-large')
    ...
    def forward(self, input_data):
        ...
        #print(f"hubert out shape: {sph_emb.shape}")
        org_sph_len = sph_len
