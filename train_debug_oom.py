...
from test_torch_memory_snapshot import start_record_memory_history, stop_record_memory_history, export_memory_snapshot

stop_record_batch_id = 20
#stop_record_batch_id = 10
MAX_NUM_OF_MEM_EVENTS_PER_SNAPSHOT = 1000000
...
class Trainer():
    ...
    def make_data_loader(self):
        ...
        if cv_list_file:
            cv_list = read_list(cv_list_file, split_cv=False, shuffle=shuffle)
            tr_list = read_list(data_list_file, split_cv=False, shuffle=shuffle)
        else:
            tr_list, cv_list = read_list(data_list_file, split_cv=True, shuffle=shuffle)
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, end_epoch):
            ...
            for batch_id, data in enumerate(self.tr_loader):
                if batch_id == stop_record_batch_id:
                    print("batch_id: {}, stop_record_batch_id: {}".format(batch_id, stop_record_batch_id))
