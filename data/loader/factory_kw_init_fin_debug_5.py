...
import numpy as np
import data.loader.data_utils_kw_init_fin_debug_5 as utils
...
def process_sampled_keyword_from_label(
    ...
    for sample in data:
        ...
        kw, kw_pos, kw_length, pos, target = utils.make_keyword(
            ...
            positive_prob=positive_prob, neg_len=neg_len, num_pre_sample=num_pre_sample, kw_position_candidate=sample['kw_candidate'],
