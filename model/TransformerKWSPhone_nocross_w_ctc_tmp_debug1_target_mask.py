...
class TransformerKWSPhone_nocross_w_ctc_tmp_debug1_target_mask(nn.Module):
    def __init__(
        self,
        audio_net_config,
        kw_net_config,
        ...
        **kwargs,
        ...
        super(TransformerKWSPhone_nocross_w_ctc_tmp_debug1_target_mask, self).__init__()
        self.sok = sok
        self.eok = eok
        # detach_config 
        # TODO: looks stupid ....   >_<
    ...
    def forward(self, input_data):
        ...
        for i, tf_layer in enumerate(self.au_kw_transformer):
            ...
            det_loss_layer = self.det_crit(det_result_layer_select, target_select)
